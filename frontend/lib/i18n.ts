...
export const STRINGS = {
  nb: {
    ...
    faqA3:
      "I EU. Lagret i Frankfurt, med en alternativ lesevei via Dublin. Schrems II-kompatibelt, bygget i Norge.",
  ...
  en: {
    ...
    faqA3:
      "In the EU. Stored in Frankfurt, with an alternative read path via Dublin. Schrems II-compliant, built in Norway.",
